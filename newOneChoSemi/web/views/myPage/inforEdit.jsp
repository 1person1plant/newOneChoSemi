						...
						<table class="table information1">
							...
							<tbody>
								...
								<tr>
									...
									<td colspan="2"><select id='phone1' class="phone"
										name='memberPhone1'>
									...
									</select> - <input type='text' id='phone2' class="inputBtn"
										name='memberPhone2' maxlength='4'
										onKeyPress='return checkNum(event)'
										value="<%=loginUser.getMemberPhone2()%>"> - <input
										type='text' id='phone3' name='memberPhone3' class="inputBtn"
										maxlength='4' onKeyPress='return checkNum(event)'
										value="<%=loginUser.getMemberPhone3()%>"></td>
								</tr>
								<tr>
