     ...
     $(document).ready(function(){
       ...
       $("#productlist tbody").on('click','button',function(){
     		...
     		if($(this).text()=="삭제"){
     			...
     			alert("정말 삭제하시겠어요?"+$(this).parent().parent().children().eq(0).text());
         ...
         $("#productlist tbody").on('click','tr',function(){
        	...
        	if(flag){
             ...
             $("#category").val($(this).children().eq(7).text());
             $("#keyword").val($(this).children().eq(8).text());
             $("#registerDate").val($(this).children().eq(9).text());
             $("#modifyDate").val($(this).children().eq(10).text());
